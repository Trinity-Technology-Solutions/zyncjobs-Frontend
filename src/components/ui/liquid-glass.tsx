...
// SVG Filter — place this once near the top of your app
...
export const GlassDock: React.FC<{ icons: DockIcon[]; href?: string }> = ({
  ...
  <GlassEffect href={href} className="rounded-3xl p-3 hover:p-4 hover:rounded-[2rem]">
...
export const GlassButton: React.FC<{
  ...
  <GlassEffect
    href={href}
    onClick={onClick}
    className={`rounded-3xl px-8 py-4 hover:px-9 hover:py-5 hover:rounded-[2rem] overflow-hidden ${className}`}
  >
    <div
...
// Glass Card — for wrapping section cards
export const GlassCard: React.FC<{
  ...
  <GlassEffect
    onClick={onClick}
    className={`rounded-2xl p-6 hover:scale-[1.02] ${className}`}
  >
    {children}
  </GlassEffect>
);

// Glass Panel — for wrapping full sections
export const GlassPanel: React.FC<{
  children: React.ReactNode;
  className?: string;
}> = ({ children, className = "" }) => (
  <GlassEffect className={`rounded-3xl p-8 ${className}`}>
    {children}
  </GlassEffect>
);
