...
const SEO_MAP: Record<string, { title: string; description: string }> = {
  ...
  '/role-selection':            { title: 'Find Jobs and Hire Talent Faster with AI | ZyncJobs',                    description: 'Find your next job or hire top talent with ZyncJobs. Create a candidate profile, post jobs, access verified listings, use AI-powered matching to connect faster.' },
