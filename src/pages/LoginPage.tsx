          ...
          <div className="w-full max-w-sm sm:max-w-md">
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-6 sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5" autoComplete="off">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-3 border border-gray-200 rounded-lg sm:rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                ...
                <div>
                  ...
                  <div className="relative flex items-center">
                    <input
                      ...
                      className="w-full h-12 px-3 sm:px-4 pr-12 border border-gray-200 rounded-lg sm:rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                    ...
                    <button
                      ...
                      className="absolute right-3 flex items-center justify-center h-full text-gray-400 hover:text-gray-600 transition-colors"
                    >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 rounded-lg sm:rounded-xl text-white font-semibold text-sm bg-blue-600 hover:bg-blue-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-3 sm:px-4 py-3 border border-gray-200 rounded-lg sm:rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-3 sm:px-4 py-3 border border-gray-200 rounded-lg sm:rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors mt-3"
              >
