        ...
        <><Header onNavigate={onNavigate} user={user} onLogout={onLogout} />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
            ...
            <div className="mb-4 sm:mb-6">
              {/* AI Insights Bar */}
              <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-violet-600 to-indigo-600 zync-gradient-anim rounded-2xl p-4 sm:p-5 mb-5 text-white shadow-lg shadow-blue-900/10">
                <div className="flex flex-col lg:flex-row items-start lg:items-center gap-3 lg:gap-4">
                  <div className="flex items-center gap-2">
                    <span className="w-8 h-8 rounded-xl bg-white/15 border border-white/25 flex items-center justify-center">
                  ...
                  <div className="relative flex-1 w-full lg:min-w-[200px]">
                    <button
                      ...
                      className="w-full flex items-center justify-between bg-white/15 hover:bg-white/25 border border-white/25 backdrop-blur-sm rounded-xl px-3.5 py-2.5 text-sm font-medium transition-colors"
                    >
                    ...
                    {showJobDropdown && (
                      <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-xl shadow-2xl shadow-blue-900/10 z-50 max-h-52 overflow-y-auto zync-pop-in">
                        <button
                    ...
                    <div className="flex flex-wrap gap-2">
                      {(['ai_score', 'skills', 'name'] as const).map(s => (
                        <button
                          key={s}
                          onClick={() => setSortBy(s)}
                          className={`text-xs px-2 sm:px-3 py-1.5 rounded-full font-medium transition-all flex items-center gap-1.5 ${sortBy === s ? 'bg-white text-blue-700 shadow-sm' : 'bg-white/20 text-white hover:bg-white/30'
                            }`}
                        >
                          {s === 'ai_score' ? (
