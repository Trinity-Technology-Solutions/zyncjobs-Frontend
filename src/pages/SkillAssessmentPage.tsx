        ...
        <div className="flex-1 max-w-6xl w-full mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-10">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6 sm:mb-8 lg:mb-10">
            <div className="mb-4 sm:mb-6 lg:mb-0">
              <h1 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-gray-800 leading-tight mb-1">
              ...
              <p className="text-gray-400 text-xs sm:text-sm mt-2 sm:mt-3">AI-powered assessments · Instant results · Shareable badges</p>
            </div>
            <div className="relative flex-shrink-0 self-center lg:mr-8">
              <div className="relative">
                <div className="w-20 sm:w-24 lg:w-28 h-20 sm:h-24 lg:h-28 bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl sm:rounded-3xl flex items-center justify-center shadow-2xl relative overflow-hidden">
          ...
          {myAssessments.length > 0 && (
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3 lg:gap-4 mb-4 sm:mb-6 lg:mb-8">
              {[
                ...
                <div key={i} className={`${s.bg} rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-5 border ${s.border} shadow-sm ${i === 2 ? 'col-span-2 sm:col-span-1' : ''}`}>
                  <div className={`text-xl sm:text-2xl lg:text-3xl font-bold ${s.color} mb-1`}>{s.value}</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6 lg:mb-8">
            {[
              ...
              <div key={i}
                className={`bg-white rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-sm border border-gray-100 ${card.highlight ? 'ring-2 ring-violet-200' : ''} hover:shadow-md transition-all duration-200 cursor-pointer active:scale-95`}
                onClick={() => { setSkillSearch(''); setShowSkillDropdown(true); }}>
                <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">{card.icon}</div>
                <p className="text-gray-700 text-sm leading-relaxed mb-3 sm:mb-4 font-medium">{card.title}</p>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-6 sm:mb-8">
            {/* Top hint bar */}
            <div className="flex items-center justify-between px-3 sm:px-5 py-2 sm:py-2.5 border-b border-gray-50">
              <div className="flex items-center gap-1.5 text-xs text-gray-400">
                <span className="w-3.5 h-3.5 text-violet-400">⚡</span>
                <span className="hidden sm:inline">Choose a skill to start your assessment</span>
                <span className="sm:hidden">Choose a skill</span>
              </div>
              <div className="flex items-center gap-1.5 text-xs text-gray-400">
                <span>🤖</span>
                <span className="hidden sm:inline">Powered by ZyncJobs AI</span>
            ...
            <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-5 py-3">
              <span className="text-gray-300 text-lg font-light hidden sm:inline">+</span>
              <div className="flex-1">
                <input
                  type="text"
                  value={skillSearch}
            ...
            {/* Popular skill pills */}
            <div className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 lg:px-5 pb-3 sm:pb-4 flex-wrap">
              {popularSkills.slice(0, window.innerWidth < 640 ? 6 : popularSkills.length).map((skill, i) => (
                <button key={i} type="button" onClick={() => selectSkill(skill)}
                  className={`flex items-center gap-1.5 text-xs px-2 sm:px-2.5 lg:px-3 py-1.5 rounded-full font-medium transition-all duration-200 active:scale-95 ${
                    selectedSkill === skill
                      ? 'bg-gray-900 text-white'
