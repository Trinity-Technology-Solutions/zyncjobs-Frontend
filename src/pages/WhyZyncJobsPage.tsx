    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-blue-50 via-orange-50 to-blue-100 text-gray-900 py-8 overflow-hidden border-b border-gray-200">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[2.35rem] xl:text-[2.6rem] font-extrabold leading-[1.15] tracking-[-0.02em] mb-2.5 bg-gradient-to-r from-blue-600 to-orange-500 bg-clip-text text-transparent">Why ZyncJobs?</h1>
          <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-4 max-w-2xl mx-auto px-4">The Platform Built for Every Job Seeker and Employer</p>
