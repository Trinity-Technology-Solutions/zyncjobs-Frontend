        ...
        <div className="px-4 py-4 border-b border-gray-100 bg-white">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <h1 className="text-xl font-bold text-gray-900 truncate">Messages</h1>
            </div>
            <button
      ...
      {selectedConversation ? (
        <div style={{display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0, position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, zIndex: 10, background: '#fff'}} className="lg:relative">
          ...
          <div className="px-4 py-4 border-b border-gray-200 bg-white flex items-center justify-between flex-shrink-0">
            <div className="flex items-center gap-3 min-w-0">
              <button
                ...
                className="lg:hidden p-1.5 hover:bg-gray-100 rounded-lg flex-shrink-0"
              >
              ...
              <div className="min-w-0">
                <h2 className="font-semibold text-gray-900 text-base truncate">{selectedConversation.employerName}</h2>
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              <button className="p-2 hover:bg-gray-100 rounded-lg text-gray-600 flex-shrink-0" title="Info">
                <Info className="w-5 h-5" />
              </button>
              <button className="p-2 hover:bg-gray-100 rounded-lg text-gray-600 flex-shrink-0" title="More">
          ...
          <div className="flex-1 overflow-y-auto bg-white">
            <div className="max-w-4xl mx-auto px-4 py-4 flex flex-col justify-end min-h-full">
              {messages.length === 0 ? (
            ...
            <div className="max-w-4xl mx-auto px-4">
              ...
              <div className="flex gap-2 items-center">
                ...
                <button
                  ...
                  className="p-2 hover:bg-gray-100 rounded-lg text-gray-500 flex-shrink-0 active:bg-gray-200"
                  title="Attach file"
                >
                ...
                <button
                  ...
                  className="p-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex-shrink-0 active:bg-blue-800"
                >
