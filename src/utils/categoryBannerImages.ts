// Default banner images per job category
...
export const CATEGORY_BANNERS: Record<string, string[]> = {
  ...
  'Software Development': [
    ...
    'https://images.unsplash.com/photo-1587620962725-abab19836100?w=800&h=400&fit=crop',
    'https://images.unsplash.com/photo-1531498860502-7c67cf519b9e?w=800&h=400&fit=crop',
  ],
  ...
  'Finance & Accounting': [
    ...
    'https://images.unsplash.com/photo-1565514158740-064f34bd6cfd?w=800&h=400&fit=crop',
  ],
  'Sales & Marketing': [
  ...
  'Legal': [
    ...
    'https://images.unsplash.com/photo-1453945619913-79ec89a82c51?w=800&h=400&fit=crop',
  ],
  'Operations': [
  ...
  'Construction': [
    ...
    'https://images.unsplash.com/photo-1590579491624-f98f36d4c763?w=800&h=400&fit=crop',
  ],
  'Hospitality & Tourism': [
  ...
  'Logistics & Supply Chain': [
    ...
    'https://images.unsplash.com/photo-1494412651409-8963ce7935a7?w=800&h=400&fit=crop',
  ],
  'Real Estate': [
  ...
  'Oil & Gas': [
    'https://images.unsplash.com/photo-1513828646384-9f4f3a3b9098?w=800&h=400&fit=crop',
    'https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=800&h=400&fit=crop',
  ],
  'Telecommunications': [
    'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=400&fit=crop',
    'https://images.unsplash.com/photo-1574870111867-089730e5a72b?w=800&h=400&fit=crop',
  ],
  'Banking & Insurance': [
...
export function getCategoryBannerOptions(category: string): string[] {
  const categoryImages = CATEGORY_BANNERS[category] || [];
  const generic = [
  ...
  // Combine category-specific first, then generic (deduped)
  const all = [...categoryImages, ...generic];
  return [...new Set(all)];
}
